...
from bandits.algorithms.variational_sivi_dgf_abl.VI_dataset import VIContextualDataset
from bandits.algorithms.variational_sivi_dgf_abl.VI_model_sivi_dgf_abl import VariationalSivi_dgf_abl


class VariationalSamplingSivi_dgf_abl(BanditAlgorithm):
  ...
  def __init__(self, name, hparams, optimizer='RMS', mode='variational'):
    ...
    self.bnn = VariationalSivi_dgf_abl(optimizer, hparams, '{}-bnn'.format(name))
