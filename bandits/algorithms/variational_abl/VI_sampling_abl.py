...
from bandits.algorithms.variational_abl.VI_model_abl import Variational_abl


class VariationalSampling_abl(BanditAlgorithm):
  ...
  def __init__(self, name, hparams, optimizer='RMS', mode='variational'):
    ...
    self.bnn = Variational_abl(optimizer, hparams, '{}-bnn'.format(name))
